...
export default function Home() {
    ...
    // Load saved city from localStorage on initial mount
    useEffect(() => {
    ...
    const handleCityChange = (cityName: string) => {
        ...
        if (found) {
            setSelectedCity(found);
            localStorage.setItem("selectedCity", found.name);
        }
    };
    ...
    return (
        <main className="relative overflow-hidden bg-main text-slate-900 min-h-screen">
            ...
            <section className="relative pt-28 pb-24 px-6 z-10">
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex justify-end mb-8">
                        <div className="inline-flex items-center gap-3 bg-white/90 backdrop-blur-md border border-slate-200/80 shadow-lg px-4 py-2.5 rounded-2xl">
                            <span className="text-xs font-black uppercase tracking-wider text-slate-500">📍 Select City:</span>
                            <select
                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="slide-up">
                            ...
                            <h1 className="heading text-5xl md:text-7xl leading-[1.05] mt-8">
                                Inspect Your New Car Before Delivery in
                                <span className="block bg-gradient-to-r from-indigo-600 via-violet-600 to-pink-500 bg-clip-text text-transparent mt-2">
                                    {selectedCity.name}
                                </span>
                            </h1>
                            ...
                            <p className="subtext text-lg max-w-xl mt-8 leading-relaxed">
                                ...
                                used cars in {selectedCity.name}.
                            ...
                            <div className="flex flex-wrap gap-4 mt-10">
                                ...
                                >
                                    Book Inspection in {selectedCity.name}
                                </button>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-14 slide-up">
                        ...
                        <h2 className="heading text-4xl md:text-5xl mt-4">
                            Choose Your Inspection in {selectedCity.name}
                        </h2>
                        <p className="subtext max-w-2xl mx-auto mt-5">
                            Whether you're taking delivery of a brand-new vehicle
                            or buying a pre-owned car in {selectedCity.name}, our independent inspectors
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                <p className="subtext leading-relaxed mb-8">
                                    Before accepting delivery from the showroom in {selectedCity.name},
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                <p className="leading-relaxed text-slate-300 mb-8">
                                    Avoid buying a problematic vehicle in {selectedCity.name}. We inspect
            ...
            <section className="px-6 py-24 relative z-10">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16 slide-up">
                        ...
                        <h2 className="heading text-4xl md:text-5xl mt-4">
                            The Smart Way To Buy A Car in {selectedCity.name}
                        </h2>
                        <p className="subtext max-w-2xl mx-auto mt-5">
                    ...
                    <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-8">
                        {[
                            ...
                            },
                            {
                                ...
                                desc: `Fast scheduling and inspections across ${selectedCity.name} & nearby areas.`,
                            },
                        ].map((item, i) => (
                            <div
                                key={item.title}
                    ...
                    <div className="space-y-10">
                        {[
                            ...
                            },
                            {
                                ...
                                desc: `Choose your preferred inspection date, time and dealership or seller location in ${selectedCity.name}.`,
                            },
                            {
                                no: "03",
            ...
            {/* TESTIMONIALS */}
            <section className="px-6 py-24 bg-gradient-to-b from-transparent to-slate-50 z-10 relative">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        <p className="text-xs uppercase tracking-[0.35em] font-black text-indigo-600">
                            CUSTOMER STORIES
                        ...
                        <h2 className="heading text-4xl md:text-5xl mt-4">
                            Trusted By Car Buyers Across {selectedCity.name}
                        </h2>
                ...
                <div className="relative overflow-hidden rounded-[3rem] max-w-6xl mx-auto">
                    ...
                    <div className="relative px-10 py-20 text-center text-white">
                        <p className="text-xs uppercase tracking-[0.35em] font-black opacity-80">
                            READY TO BUY IN {selectedCity.name.toUpperCase()}?
                        </p>
                        ...
                        <p className="max-w-2xl mx-auto mt-8 text-white/80 text-lg leading-relaxed">
                            Whether it's a brand-new vehicle or a used car in {selectedCity.name},
