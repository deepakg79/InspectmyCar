                ...
                <div className="h-20 flex items-center justify-between">
                    ...
                    >
                        ...
                        >
                            ...
                            <div
                                className={`absolute right-0 top-full pt-3 w-64 transition-all duration-200 ${openNewCars
                            ...
                            >
                                <div className="bg-white/90 backdrop-blur-xl border border-white/40 shadow-xl rounded-2xl p-2">
                                    <Link
                                        ...
                                        className="block px-4 py-3 rounded-xl hover:bg-indigo-50"
                                    >
                                        🚗 PDI Pune
                                    </Link>
                        ...
                        >
                            ...
                            <div
                                className={`absolute right-0 top-full pt-3 w-64 transition-all duration-200 ${openUsedCars
                                    ? "opacity-100 visible translate-y-0"
                                    : "opacity-0 invisible translate-y-2"
                                    }`}
                            >
                                <div className="bg-white/90 backdrop-blur-xl border border-white/40 shadow-xl rounded-2xl p-2">
                                    <Link
                                        ...
                                        className="block px-4 py-3 rounded-xl hover:bg-pink-50"
                                    >
                                        🚙 PDI Pune
                                    </Link>
                        ...
                        <div className="rounded-3xl border border-slate-200 bg-white p-5 shadow-xl">
                            ...
                            <div className="rounded-2xl border border-slate-200">
                                <button
                                    ...
                                    className="w-full flex items-center justify-between p-5 hover:bg-indigo-50"
                                >
                                    <div>
                            ...
                            <div className="mt-3 rounded-2xl border border-slate-200">
                                <button
                                    ...
                                    className="w-full flex items-center justify-between p-5 hover:bg-pink-50"
                                >
                                    <div>
                                        <p className="font-black text-xl">
                                            🚙 Used Cars
